...
import getDictWord from '../../declinatio-dvq15m/declensions.js?v=2c';
...
function generateWord() {
  ...
  const rand = () => Math.random() * declensions.length >> 0;
  const declension = +select.value || declensions[rand()];
